    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                while (result.next()) {
                    System.out.println(result.getInt("idp") + " " + result.getString("name") + " " + result.getDate("regdate"));
                }
                ...
                while (result.next()) {
                    System.out.println(result.getInt("ida") + " " + result.getString("state") + " " + result.getDate("appdate") + " " + result.getInt("idd"));
                }
            } else if (command == 6) {
